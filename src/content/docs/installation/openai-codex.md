...
If you are doing this from a Paperclip company, use [Install Agent Analytics on Paperclip](/guides/paperclip/) for the company-skill path. Use this page when you need the raw Codex install flow itself.
