...
המסלול הראשי הוא agent-first: מתקינים את Agent Analytics בתוך הסוכן שכבר עובד אצלכם, נותנים לסוכן לפתוח אישור בדפדפן אם צריך גישת חשבון, ואז מבקשים ממנו ליצור את הפרויקט ולהטמיע את המעקב.
...
אם נפתח דף אישור בדפדפן, התחברו עם Google או GitHub, אשרו, ותנו לסוכן להמשיך. האישור הזה יוצר או מחבר את החשבון שלכם ונותן לסוכן את ה-session שהוא צריך.
